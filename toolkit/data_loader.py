...
def get_dataloader_from_datasets(
    ...
    if accelerator.num_processes > 1:
        # ai-toolkit bucket datasets already return complete batches
        # (DataLoader uses batch_size=None), which Accelerate cannot wrap with
        # its BatchSamplerShard. Shard the dataset indices directly instead.
