...
try:
    ...
    def add_album_artwork(*args, **kwargs):
        raise ImportError("av is required to add album artwork to mp3 outputs")
    ...
    def save_image(self, image, count: int = 0, max_count=0):
        ...
        if isinstance(image, list):
            ...
            if torchaudio is None:
                raise ImportError(
                    "torchaudio is required to save audio outputs. "
                    "Install torchaudio or use an image/video output format."
                )
